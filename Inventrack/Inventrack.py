...
import smtplib
##..............................................sending email......................................................................
sender_email= "inventrack1234@gmail.com"
sender_password="BE_PROJECT22"
receiver_email="abhijeetgaonkar172@gmail.com"  # store manager's email
subject = "Inventrack Transaction"
body1 ="A new item is added in the inventory"
body2 ="Item is withdrawn from the inventory"
body3 ="Item updated in the inventory"
msg1 = f'Subject: {subject}\n\n{body1}'
msg2 = f'Subject: {subject}\n\n{body2}'
msg3 = f'Subject: {subject}\n\n{body3}'
server = smtplib.SMTP('smtp.gmail.com',587)     #create gmail server using smtp & uses smtp port number 587
...
class MainScreen(QMainWindow):
    def __init__(self):
        ...
        self.imageholder_2.setPixmap(QPixmap('search.png'))
        values_list = sheet.col_values(2)
        del values_list[0]
        print(values_list)
        self.comboBox.addItems(values_list)
    ...
    #Search the data and display on mainscreen
    def searchdata(self):
        Search_text = self.comboBox.currentText()
        print(Search_text)
        try:
            cell = sheet.find(Search_text)
            print("Found something at R%sC%s" % (cell.row, cell.col))
            product_id = sheet.cell(cell.row, 1).value
            ...
            self.productID.setText(product_id)
...
class AddNewItemScreen(QDialog):
        ...
        def Enter_Data(self):
            ...
            if Product_ID == "" or Product_Name=="" or Box == "" or Quantity=="" or Mfg_Date=="" or Exp_Date==""or GRN=="":
                ...
                print("Add new item email sent")
                #self.comboBox.addItem(Product_Name)
                #global addnewitem
                #widget.removeWidget(addnewitem)
        ...
        def withdrawfunction(self):
            ...
            try:
                ...
                if (box_val >= box_user_input and qty_val >= qty_user_input):
                    ...
                    print("Item withdrawal email sent")
                else:
                    print("No stock")
        ...
        def Enter_Data(self):
            ...
            if Product_ID == "" or Product_Name=="" or Box == "" or Quantity=="" or Mfg_Date=="" or Exp_Date==""or GRN=="":
                ...
                try:
                    ...
                    server.sendmail(sender_email, receiver_email, msg3)
                    print("Item updated email sent")
                except:
                    print("No Match Found")
                    self.errormessage.setText("No Match Found")
...
if __name__ == "__main__":
    ...
    widget.setWindowTitle("Inventrack")
    widget.show()
    app.exec_()